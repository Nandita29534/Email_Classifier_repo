...
if not email_text:
    ...
    with col1:
        if st.button("✅ Correct"):
            ...
            st.info("Feedback saved as correct ✅")

    with col2:
        if st.button("❌ Incorrect"):
        # Let user pick from existing OR enter their own
        ...
        if st.button("Save Correction"):
            ...
            st.info(f"Feedback saved as incorrect ❌ with correction: {final_label}. This will help improve the model")
